...
/* harmony import */ var _module_counter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./module/counter */ "./js/module/counter.js");
/* harmony import */ var _module_gallery__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./module/gallery */ "./js/module/gallery.js");
/* harmony import */ var _module_main_slider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./module/main-slider */ "./js/module/main-slider.js");
/* harmony import */ var _module_nav__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./module/nav */ "./js/module/nav.js");
/* harmony import */ var _select_custom_select__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./select/custom-select */ "./js/select/custom-select.js");
      ...
      window.addEventListener('DOMContentLoaded', function () {
        // Modules
        Object(_module_nav__WEBPACK_IMPORTED_MODULE_3__["initNav"])();
        Object(_module_main_slider__WEBPACK_IMPORTED_MODULE_2__["initMainSlider"])();
        Object(_module_counter__WEBPACK_IMPORTED_MODULE_0__["initCounter"])();
        //custom select
        var select = new _select_custom_select__WEBPACK_IMPORTED_MODULE_4__["CustomSelect"]();
        select.init();
        Object(_module_gallery__WEBPACK_IMPORTED_MODULE_1__["initGallery"])();
      });

      /***/
    }),

/***/ "./js/module/counter.js":
/*!******************************!*\
  !*** ./js/module/counter.js ***!
  \******************************/
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initCounter", function () { return initCounter; });
      var initCounter = function initCounter() {
        var input = document.querySelector('.counter__input');
        var btnMinus = document.querySelector('.counter__btn--minus');
        var btnPlus = document.querySelector('.counter__btn--plus');
        if (input) {
          if (input.value <= 1) {
...
/* harmony import */ var _vendor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../vendor */ "./js/vendor.js");
      ...
      var initMainSlider = function initMainSlider() {
        var sliderPopular = document.querySelector('.popular__slider');
        if (sliderPopular) {
...
/* harmony import */ var _vendor_baguetteBox__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vendor/baguetteBox */ "./js/vendor/baguetteBox.js");
/* harmony import */ var _vendor_baguetteBox__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_vendor_baguetteBox__WEBPACK_IMPORTED_MODULE_1__);
      // Swiper 7.4.1
...
const categoryButton = document.querySelector('.category-filter-button');
const categorySection = document.querySelector('.hidden-category');

if (categoryButton) {
  categoryButton.addEventListener('click', () => {
    categorySection.classList.toggle('is-active');

    if (categorySection.classList.contains('is-active')) {
      categorySection.style.maxHeight = categorySection.scrollHeight + 'px';
    } else {
      categorySection.style.maxHeight = null;
    }
  });
}
